...
Foi feito uma implementação em que, com apenas 1 iteração sobre a lista de
arquivos analisados, conseguimos retornar as 2 saídas. Ambos os algoritmos estão
implementados em um mesmo método.
